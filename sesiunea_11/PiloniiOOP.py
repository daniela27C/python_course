...
# abstractizare - reprezinta crearea a ceea ce putem sa  numim un tipar pentru celelalte clase,
# astfel incat oricare clasa va veni si va mosteni clasa abstracta va fi obligata sa implementeze
# (adica sa dea un comportament) metodelor abstracte definite in acea clasa.
